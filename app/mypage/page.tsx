...
import {
  User, Mail, LogOut, Heart, Building2, Phone, MapPin,
  Trash2, ChevronRight, Shield, Cross, ExternalLink, Bookmark,
} from "lucide-react"
...
export default function MyPage() {
  ...
  // 즐겨찾기
  const [bookmarkTab, setBookmarkTab] = useState<"hospital" | "pharmacy">("hospital")
  ...
  const handleRemoveBookmark = async (type: "hospital" | "pharmacy", itemId: string) => {
  ...
  const currentBookmarks = bookmarkTab === "hospital" ? hospitals : pharmacies
              ...
              <CardHeader className="pb-3">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <CardTitle className="text-lg">{nickname || "사용자"}</CardTitle>
              ...
              <CardContent className="space-y-3 border-t pt-4">
                <div className="flex gap-2">
                  <Input
                    ...
                    className="flex-1"
                  />
                  <Button onClick={handleSaveProfile} disabled={saving} size="default">
                    {saving ? "저장 중..." : "저장"}
                  </Button>
                </div>
                {saveMsg && (
                  <p className={`text-xs ${saveMsg.includes("실패") ? "text-destructive" : "text-emerald-600"}`}>
                    {saveMsg}
                  </p>
                )}
              </CardContent>
              ...
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-1">
                    <Button
                      variant={bookmarkTab === "hospital" ? "default" : "outline"}
                      size="sm"
                    ...
                    <Button
                      variant={bookmarkTab === "pharmacy" ? "default" : "outline"}
                      size="sm"
                ...
                {bookmarkLoading ? (
                  ...
                  <div className="flex flex-col items-center py-8 text-center">
                    ...
                    <p className="text-sm font-medium text-muted-foreground">
                      즐겨찾기한 {bookmarkTab === "hospital" ? "병원" : "약국"}이 없습니다
                    </p>
                        ...
                        <div className="flex items-start justify-between">
                          ...
                          <div className="flex shrink-0 items-center gap-1">
                            ...
                            <Button
                              ...
                              onClick={() => handleRemoveBookmark(bookmarkTab, item.id)}
                            >
