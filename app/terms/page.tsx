    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-3xl mx-auto px-4 py-6">
        <div className="bg-card rounded-2xl shadow-sm p-6 space-y-6 text-foreground text-sm leading-relaxed">
          <p className="text-xs text-muted-foreground">시행일: 2025년 2월 24일</p>
          ...
          <section>
            <h2 className="text-base font-bold mb-2">제3조 (약관의 효력 및 변경)</h2>
          ...
          <section>
            <h2 className="text-base font-bold mb-2">제4조 (서비스의 제공)</h2>
          ...
          <section>
            <h2 className="text-base font-bold mb-2">제5조 (서비스 이용 시 주의사항)</h2>
          ...
          <section>
            <h2 className="text-base font-bold mb-2">제6조 (회원가입 및 계정)</h2>
            <ul className="list-decimal list-inside space-y-1">
          ...
          <section>
            <h2 className="text-base font-bold mb-2">제7조 (이용자의 의무)</h2>
          ...
          <section>
            <h2 className="text-base font-bold mb-2">제8조 (면책 조항)</h2>
            <ul className="list-decimal list-inside space-y-1">
          ...
          <section>
            <h2 className="text-base font-bold mb-2">제9조 (지적재산권)</h2>
            <p>
