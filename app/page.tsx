        ...
        <section className="border-y border-border bg-muted/30 py-16 md:py-24">
          <div className="container mx-auto px-4">
            <div className="mb-12 text-center">
              <h2 className="text-pretty text-3xl font-bold md:text-4xl">편하루가 특별한 이유</h2>
            </div>
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
              <div className="text-center">
                ...
                <h3 className="mb-2 text-lg font-semibold">24시간 정보 확인</h3>
                <p className="text-sm text-muted-foreground">영업 중인 병원/약국만 필터링하거나 야간 진료 가능한 곳을 쉽게 찾을 수 있어요.</p>
              </div>
              <div className="text-center">
                <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-primary/10">
