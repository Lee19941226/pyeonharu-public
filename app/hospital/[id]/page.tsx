    ...
    return (
      <div className="flex min-h-screen flex-col bg-background">
        ...
        <main className="flex flex-1 flex-col items-center justify-center px-4">
          ...
          <h1 className="mb-2 text-xl font-bold">병원 정보를 찾을 수 없습니다</h1>
          ...
          <div className="mx-auto max-w-2xl">
            <div className="mb-6">
              <div className="mb-2 flex flex-wrap items-center gap-2">
                <Badge variant="secondary"><Building2 className="mr-1 h-3 w-3" />{type}</Badge>
            ...
            <Card className="mb-6">
              <CardHeader><CardTitle className="text-lg">병원 정보</CardTitle></CardHeader>
              <CardContent className="space-y-4">
                ...
                {type && (
                  <div className="flex items-center gap-3">
                    ...
                    <div><p className="text-sm text-muted-foreground">의료기관 종류</p><p className="font-medium">{type}</p></div>
                  </div>
                )}
                {department && (
                  <div className="flex items-center gap-3">
                    <Stethoscope className="h-5 w-5 text-muted-foreground" />
                    <div><p className="text-sm text-muted-foreground">진료과목</p><p className="font-medium">{department}</p></div>
                  </div>
                )}
              </CardContent>
            </Card>
